...
export type TodosWhereInput = {
    ...
    desc?: Prisma.StringFilter<"Todos"> | string;
...
export type TodosScalarWhereWithAggregatesInput = {
    ...
    desc?: Prisma.StringWithAggregatesFilter<"Todos"> | string;
...
export type TodosOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "title" | "desc" | "done" | "userId", ExtArgs["result"]["todos"]>;
...
export interface TodosFieldRefs {
    ...
    readonly desc: Prisma.FieldRef<"Todos", 'String'>;
